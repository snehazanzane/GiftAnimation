 ...
 */
public class AnimationView extends View implements View.OnLayoutChangeListener {
    private List<Animation> confetti;
    private boolean terminated;

    private boolean touchEnabled;
    private Animation draggedConfetto;

    public static AnimationView newInstance(Context context) {
        final AnimationView confettiView = new AnimationView(context, null);
     ...
     */
    public void bind(List<Animation> confetti) {
        this.confetti = confetti;
    }

    /**
     * @see AnimationManager#setTouchEnabled(boolean)
     *
    ...
    protected void onAttachedToWindow() {
        ...
        // has a AnimationManager backing it and should just be terminated.
        if (confetti == null) {
            terminate();
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!terminated) {
            canvas.save();
            for (Animation confetto : this.confetti) {
        ...
        if (touchEnabled) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    for (Animation confetto : confetti) {
