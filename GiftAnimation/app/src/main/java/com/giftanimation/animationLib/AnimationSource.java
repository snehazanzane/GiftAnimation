...
public class AnimationSource {
     ...
     *
     * @param x x-coordinate of the point relative to the {@link AnimationView}'s parent.
     * @param y y-coordinate of the point relative to the {@link AnimationView}'s parent.
     */
    public AnimationSource(int x, int y) {
        this(x, y, x, y);
    }
     ...
     *
     * @param x0 x-coordinate of the first point relative to the {@link AnimationView}'s parent.
     * @param y0 y-coordinate of the first point relative to the {@link AnimationView}'s parent.
     * @param x1 x-coordinate of the second point relative to the {@link AnimationView}'s parent.
     * @param y1 y-coordinate of the second point relative to the {@link AnimationView}'s parent.
     */
    public AnimationSource(int x0, int y0, int x1, int y1) {
        this.x0 = x0;
        this.y0 = y0;
        this.x1 = x1;
        this.y1 = y1;
