...
public class AnimationManager {
    ...
    private final AnimationGenerator confettoGenerator;
    private final AnimationSource confettiSource;
    private final ViewGroup parentView;
    private final AnimationView confettiView;

    private final Queue<Animation> recycledConfetti = new LinkedList<>();
    private final List<Animation> confetti = new ArrayList<>(300);
    ...
    public AnimationManager(Context context, AnimationGenerator confettoGenerator,
                            AnimationSource confettiSource, ViewGroup parentView) {
        this(confettoGenerator, confettiSource, parentView, AnimationView.newInstance(context));
    }

    public AnimationManager(AnimationGenerator confettoGenerator,
                            AnimationSource confettiSource, ViewGroup parentView, AnimationView confettiView) {
     ...
     */
    public AnimationManager setNumInitialCount(int numInitialCount) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setEmissionDuration(long emissionDurationInMillis) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setEmissionRate(float emissionRate) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setVelocityX(float velocityX) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setVelocityX(float velocityX, float velocityDeviationX) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setVelocityY(float velocityY) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setVelocityY(float velocityY, float velocityDeviationY) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setAccelerationX(float accelerationX) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setAccelerationX(float accelerationX, float accelerationDeviationX) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setAccelerationY(float accelerationY) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setAccelerationY(float accelerationY, float accelerationDeviationY) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setTargetVelocityX(float targetVelocityX) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setTargetVelocityY(float targetVelocityY) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setInitialRotation(int initialRotation) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setInitialRotation(int initialRotation, int initialRotationDeviation) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setRotationalVelocity(float rotationalVelocity) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setRotationalAcceleration(float rotationalAcceleration) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setTargetRotationalVelocity(float targetRotationalVelocity) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setBound(Rect bound) {
        this.bound = bound;
        return this;
    }
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setTTL(long ttlInMillis) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager enableFadeOut(Interpolator fadeOutInterpolator) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager disableFadeOut() {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setTouchEnabled(boolean touchEnabled) {
     ...
     * @return the confetti manager so that the set calls can be chained.
     */
    public AnimationManager setConfettiAnimationListener(ConfettiAnimationListener listener) {
    ...
    private void cleanupExistingAnimation() {
        ...
        final Iterator<Animation> iterator = confetti.iterator();
    ...
    private void addNewConfetti(int numConfetti, long initialDelay) {
        for (int i = 0; i < numConfetti; i++) {
            Animation confetto = recycledConfetti.poll();
            if (confetto == null) {
    ...
    private void updateConfetti(long elapsedTime) {
        final Iterator<Animation> iterator = confetti.iterator();
        while (iterator.hasNext()) {
            final Animation confetto = iterator.next();
    ...
    private void addConfetto(Animation confetto) {
    ...
    private void removeConfetto(Animation confetto) {
    ...
    private void configureConfetto(Animation confetto, AnimationSource confettiSource,
    ...
    public interface ConfettiAnimationListener {
        void onAnimationStart(AnimationManager confettiManager);

        void onAnimationEnd(AnimationManager confettiManager);

        void onConfettoEnter(Animation confetto);

        void onConfettoExit(Animation confetto);
    }

    public class ConfettiAnimationListenerAdapter implements ConfettiAnimationListener {
        @Override
        public void onAnimationStart(AnimationManager confettiManager) {
        }

        @Override
        public void onAnimationEnd(AnimationManager confettiManager) {
        }

        @Override
        public void onConfettoEnter(Animation confetto) {
        }

        @Override
        public void onConfettoExit(Animation confetto) {
        }
    }
}
